...
import learn.atharv.studentmoudule.databinding.ActivityStudentMainScreenBinding
...
class StudentMainScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_student_main_screen)
