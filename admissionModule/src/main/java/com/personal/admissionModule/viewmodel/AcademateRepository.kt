...
import com.personal.admissionModule.api.AcademateWebService
...
class AcademateRepository(private val webService : AcademateWebService = AcademateWebService(),
    ...
    suspend fun getComputerApplications(brach: String):Response<String> {
        return webService.api.getComputerApplications(brach)
    }
    ...
    suspend fun getDownloadApplications(uid: String):Response<DownloadApplicationsResponse> {
        return webService.api.getDownloadApplications(uid)
    }
