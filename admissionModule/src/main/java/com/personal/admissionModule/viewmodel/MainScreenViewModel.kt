...
class MainScreenViewModel(
    ...
    var ComputerApplicationResponse: MutableLiveData<Response<String>> =
        MutableLiveData()
    ...
    var CurrentCourseDetailsResponse: MutableLiveData<Response<CurrentCourseDetailsResponse>> =
        MutableLiveData()
    var DownloadApplicationsResponse: MutableLiveData<Response<DownloadApplicationsResponse>> =
        MutableLiveData()
...
//    }
    ...
    fun getComputerApplications(brach: String) {
        viewModelScope.launch {
            val response = repository.getComputerApplications(brach)
            ComputerApplicationResponse.value = response
        }
    }
    ...
    fun getDownloadApplications(uid: String) {
        viewModelScope.launch {
            val response = repository.getDownloadApplications(uid)
            DownloadApplicationsResponse.value = response
        }
    }
